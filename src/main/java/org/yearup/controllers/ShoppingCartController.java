...
public class ShoppingCartController
{
    ...
    public ResponseEntity<ShoppingCart> addProductById(@PathVariable int productId, Principal principal){
        String userName = principal.getName();
        User user = userService.getByUserName(userName);
        int userId = user.getId();
        ShoppingCart saved = shoppingCartService.addProduct(productId, userId);
    ...
    public ResponseEntity<ShoppingCart> updateCart(@PathVariable int productId, @RequestBody CartItem cartItem, Principal principal){
        String userName = principal.getName();
        User user = userService.getByUserName(userName);
        int userId = user.getId();
